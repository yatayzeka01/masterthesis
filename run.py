...
def main():
    ...
    input_path, output_path, min_time_interval_size, min_number_of_distinct_days, start_date_inp, kuntaflag = (sys.argv[1:])
    ...
    data = prepare(input_path, time_interval, valid_stocks_list, kuntaflag)
