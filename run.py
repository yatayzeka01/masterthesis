...
@click.option("--out", "-o", "output_path", required=True, default="info.txt",
			help="Path to text file to store the short info.")
@click.option("--min_size", "-min_s", "min_time_interval_size", required=True, default=7,
			help="Minimum time interval size.")
@click.option("--min_day", "-min_d", "min_number_of_distinct_days", required=True, default=800,
			help="Minimum number of distinct days.")
